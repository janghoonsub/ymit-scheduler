...
public class GoogleCalendarAdapter {
	...
	private GoogleCalendarAdapter(){
		...
		clientId = "902042563076-fos3frfktt8mfugrm7qn4jc8s226sgnb.apps.googleusercontent.com";
		clientSecret = "ZvDkCVdnaWW-7i-veaI5M0_J";
...
//			Long time = new Long(accessTokenResponse.expiresIn + 3600);
	...
	public Events getEvents() throws IOException {
        ...
        if((Integer.parseInt(month)+2)>12) {
        	month2 = (Integer.parseInt(month)+2-12)+"";
        	year2 = (Integer.parseInt(year)+1)+"";
        } else {
        	month2 = (Integer.parseInt(month)+2)+"";
        	year2 = year;
        }
        
        today.add(java.util.Calendar.MONTH, 2);
        String date2 = Integer.toString(today.getActualMaximum(java.util.Calendar.DATE));
...
//	                .setTimeMin("2011-01-01T00:00:00Z")
	                ...
	                .setTimeMax(year2 + "-" + month2 + "-" + date2 + "T23:59:59Z")//~까지 일정 받아옴.
